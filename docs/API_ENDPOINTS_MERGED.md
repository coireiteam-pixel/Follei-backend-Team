# Follei API Endpoints - Merged & Re-ordered
...
- `POST   /api/opportunities/import-csv`
...
- `POST   /api/campaigns/{campaign_id}/leads/{lead_id}`
...
- `GET    /api/campaign-metrics/{metric_id}`
- `DELETE /api/campaign-metrics/{metric_id}`
